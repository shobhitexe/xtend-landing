...
export default function Launch() {
  return (
    <section
      id="launch"
      className="mt-[100px] text-center bg-launchBg bg-center md:w-[70%] w-[80%] mx-auto md:p-20 sm:p-10 p-5 max-sm:py-10 rounded-3xl flex flex-col sm:gap-8 xs:gap-5 gap-3"
    >
