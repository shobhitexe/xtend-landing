  ...
  return (
    <section className="mt-[100px]" id="pricing">
      ...
      <div className="mt-20 flex sm:flex-row flex-col items-stretch justify-center md:gap-10 gap-5 sm:px-10 px-5">
        <div className="bg-[#E2F3FC] p-5 md:w-[450px] w-fit basis-1/2 rounded-2xl flex flex-col justify-between items-stretch gap-5">
        ...
        <div className="bg-fullWebsiteCardBg p-5 md:w-[450px] w-full basis-1/2 rounded-2xl flex flex-col justify-between items-stretch gap-5">
